<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Supprimer un rapport de visite') }}
        </h2>
    </x-slot>
                                        ...
                                        @if($rapports->isNotEmpty())
                                            <thead >
                                                <tr class="text-white">
                                                    ...
                                                    <td class="bg-success">Bilan</strong></td>
                                                    <td class="bg-success">Supprimer</strong></td>
                                                </tr>
                                            </thead>
                                            <tbody >
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{-- Lien qui récupère le numéro pour delete --}}
                                                        <a href = '{{ route ('delete', ['id'=>$info->RAP_NUM]) }}'><img class="w-8" src="images/10.png"></a>
                                                    </td>
                                                </tr>
                                                @endforeach
                                            </tbody>
