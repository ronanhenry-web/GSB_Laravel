<div class="flex ml-4">   
            ...
            <div class="modal-box relative bg-gray-300">
                ...
                <div class="form-control py-4">
                    <div class="input-group">
                        <input type="text" placeholder="Rechercher par NOM" class="input input-bordered" name="q" value="<?php echo e(request()->q ?? ''); ?>">
                    ...
                    <label class="input-group">
                        <select name="rechercheParVille" onChange="form.submit()" class="select select-bordered select-primary text-black">
                            ...
                            <?php $__currentLoopData = $praticiens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($info->PRA_VILLE); ?>"><?php echo e($info->PRA_VILLE); ?></option>
    ...
    <div class="text-black">
        <form action="<?php echo e(route('research')); ?>">
            <div>
...
<?php /**PATH C:\wamp64\www\gsb\resources\views/search.blade.php ENDPATH**/ ?>